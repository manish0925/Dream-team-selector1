...
class Ui_MainWindow(object):
    ...
    # This block of code set the main window for the GUI window
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1370,690)
        MainWindow.move(0,0)
...
"background-color: rgb(140, 219, 118);\n"
"}")
...
if __name__ == "__main__":
    ...
    #icon = QtGui.QIcon("D:\3rd Semester\MyProject")
